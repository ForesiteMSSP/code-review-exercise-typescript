...
import { getIssuesByProject, searchIssues } from "~/services/jira";
...
export function loader({ params, request }: Route.LoaderArgs) {
  ...
  if (search) {
    const issues = searchIssues(params.projectKey, search);
    return { issues, projectKey: params.projectKey, search };
  }
  ...
  return { issues, projectKey: params.projectKey, search: null };
}
